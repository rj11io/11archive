...
- **Keep formative and summative separate**, in the sense of
  [13](13-people-and-organisations.md). A measure used to improve should not also be used
  to judge.
...
[11](11-health-and-diagnostics.md).
...
([05](05-software-concurrency-and-state.md)). Where that is not possible, the fallback is
