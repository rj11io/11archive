...
[09](09-safety-critical-and-standards.md). These methods attack it, ordered from cheapest
to most committing.
...
A or B, compare a pre-declared metric. Every element from [10](10-science-and-statistics.md)
...
[10](10-science-and-statistics.md): peeking, multiple metrics, underpowered tests, and no
...
[09](09-safety-critical-and-standards.md), and it is the control that machine learning
...
2. **The sample size is not fixed.** Counting continues until the evidence is strong enough
   ...
   [12](12-materials-and-manufacturing.md) applied to democracy.
