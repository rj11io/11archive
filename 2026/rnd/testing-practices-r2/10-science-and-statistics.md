...
figures in [06](06-software-non-functional.md), where 57% and 22.6% both described the
...
- **Preregistration**: publish the hypothesis, the sample size, and the analysis plan
  ...
  [07](07-software-practice-and-workflow.md), and for the same reason: a prediction made
