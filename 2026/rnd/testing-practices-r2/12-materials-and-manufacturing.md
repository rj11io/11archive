...
[15](15-cross-domain-map.md) sketches what it would look like. The caveat that keeps it
honest is in [17](17-limits-of-the-frame.md): sampling plans rest on a probability model
...
[10](10-science-and-statistics.md). Continuously monitoring a fixed-sample test inflates the
...
[02](02-software-scope-levels.md): your source is correct, and your build and publish
...
flaky ([02](02-software-scope-levels.md)), which in manufacturing terms is a gauge that
...
packaged-artifact test in [02](02-software-scope-levels.md) closes at the other end of the
pipeline.
...
discussed in [16](16-how-testing-fails.md).
...
[09](09-safety-critical-and-standards.md). Verification asks whether you followed the
