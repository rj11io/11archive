...
**One original calculation.** The diagnostic table in [09](09-health-and-diagnostics.md) was
...
[13](13-cross-domain-map.md), the six-part frame in [01](01-anatomy-of-a-test.md), and the
failure taxonomy in [14](14-how-testing-fails.md) are original to this report. They are
...
- Any quantitative claim about which practices produce better outcomes. The empirical
  ...
  which is itself covered in [06](06-software-practice-and-workflow.md).
...
- Accessibility automation coverage is reported as 57%, 20% to 40%, 29%, and 22.6% by
  ...
  [05](05-software-non-functional.md).
...
- The "100x cost of a late defect" curve is widely cited and has no traceable dataset; see
  [06](06-software-practice-and-workflow.md).
